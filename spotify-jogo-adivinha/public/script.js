...
fetch(`https://api.spotify.com/v1/playlists/${playlistId}/tracks?limit=15`, {
headers: {
...
resultDiv.innerHTML = `<p>Incorreto! A música correta
era: ${correctTrack.name}</p>`;
}

document.getElementById('nextButton').style.display =
'block'; // Exibe o botão "Próximo"
